...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleInvalidTrade(InvalidTradeEventException exception) {
        return error(HttpStatus.BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(PositionNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleNotFound(PositionNotFoundException exception) {
        return error(HttpStatus.NOT_FOUND, exception.getMessage());
    }

    @ExceptionHandler(DuplicateTradeException.class)
    public ResponseEntity<Map<String, Object>> handleDuplicateTrade(DuplicateTradeException exception) {
